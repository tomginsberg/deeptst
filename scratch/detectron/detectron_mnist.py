...
from data.sample_data.mnist import mnist
...
load_model = lambda: pretrained.resnet18_pretrained_celeb_pale_skin_for_male_classification()
p_train, p_val, p_test_all = [mnist(split=x) for x in ['train', 'val', 'iid_test']]
q_all = mnist(split='ood_test')
